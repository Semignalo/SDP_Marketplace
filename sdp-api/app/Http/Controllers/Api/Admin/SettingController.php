...
class SettingController extends Controller
{
    ...
    private const KNOWN_KEYS = [
        ...
        'shipping_min_free' => ['Minimum Belanja Gratis Ongkir (Rp)', 'number', 'Pengiriman'],
        'shipping_max_free' => ['Maksimal Subsidi Ongkir (Rp)', 'number', 'Pengiriman'],
        'shipping_flat_default' => ['Ongkir Flat Default (Rp)', 'number', 'Pengiriman'],
        'rajaongkir_origin_city_id' => ['Kota Asal Pengiriman (ID RajaOngkir)', 'number', 'Pengiriman'],
        ...
        'email_cs' => ['Email CS', 'text', 'Kontak'],
        'social_instagram' => ['Instagram URL', 'text', 'Kontak'],
        'social_facebook' => ['Facebook URL', 'text', 'Kontak'],
