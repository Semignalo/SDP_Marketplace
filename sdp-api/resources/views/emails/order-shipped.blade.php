                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <p style="margin:0; font-size:16px; font-weight:700; color:#1d4ed8;">Pesananmu sudah dikirim!</p>
                                        <p style="margin:4px 0 0; font-size:13px; color:#2563eb;">Sedang dalam perjalanan ke alamatmu.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="margin:0 0 24px; font-size:14px; color:#52525b; line-height:1.6;">
                                Halo <strong>{{ $order->shipping_name }}</strong>, pesanan berikut sudah diserahkan ke kurir.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fafafa; border:1px solid #e4e4e7; border-radius:8px; margin-bottom:24px;">
                                ...
                                <tr>
                                    <td style="padding:12px 20px;">
                                        ...
                                        <p style="margin:0; font-size:14px; font-weight:600;">{{ $order->shipping_courier ?? '-' }}</p>
                                    </td>
                                </tr>
                                @if ($order->tracking_number)
                                <tr>
                                    <td style="padding:12px 20px; border-top:1px solid #e4e4e7;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:1px; color:#a1a1aa;">Nomor Resi</p>
                                        <p style="margin:0; font-size:14px; font-weight:600;">{{ $order->tracking_number }}</p>
                                    </td>
                                </tr>
                                @endif
                            </table>
                            ...
                            <p style="margin:16px 0 0; font-size:12px; color:#a1a1aa; line-height:1.6; text-align:center;">
                                Lacak resi langsung di situs {{ $order->shipping_courier }}:<br>
                                <a href="{{ $courierTrackingUrl }}" style="color:#52525b; word-break:break-all;">{{ $courierTrackingUrl }}</a>
                            </p>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:24px 32px; background-color:#fafafa; border-top:1px solid #e4e4e7;">
                            <p style="margin:0; font-size:12px; color:#a1a1aa; line-height:1.6;">
                                Email ini dikirim karena pesananmu di SDP Marketplace baru saja dikirim oleh penjual.
                            </p>
                        </td>
                    </tr>
