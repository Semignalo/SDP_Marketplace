                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <p style="margin:0; font-size:16px; font-weight:700; color:#1d4ed8;">Your order has shipped!</p>
                                        <p style="margin:4px 0 0; font-size:13px; color:#2563eb;">It's on its way to you.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="margin:0 0 24px; font-size:14px; color:#52525b; line-height:1.6;">
                                Hi <strong>{{ $order->shipping_name }}</strong>, your order has been handed to the courier.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fafafa; border:1px solid #e4e4e7; border-radius:8px; margin-bottom:24px;">
                                ...
                                <tr>
                                    <td style="padding:12px 20px; border-top:1px solid #e4e4e7;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:1px; color:#a1a1aa;">Tracking Number</p>
                            ...
                            <p style="margin:16px 0 0; font-size:12px; color:#a1a1aa; line-height:1.6; text-align:center;">
                                Track directly on {{ $order->shipping_courier }}'s website:<br>
                    ...
                    <tr>
                        <td style="padding:24px 32px; background-color:#fafafa; border-top:1px solid #e4e4e7;">
                            <p style="margin:0; font-size:12px; color:#a1a1aa; line-height:1.6;">
                                This email was sent because your order at SDP Marketplace was just shipped by the seller.
                            </p>
                        </td>
                    </tr>
