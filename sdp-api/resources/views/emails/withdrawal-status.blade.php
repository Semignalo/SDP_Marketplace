                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#ffffff; border:1px solid #e4e4e7; border-radius:12px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="background-color:#f0fdf4; border-bottom:1px solid #bbf7d0; padding:20px 32px;">
                            <p style="margin:0; font-size:16px; font-weight:700; color:#15803d;">✅ Withdrawal approved</p>
                            <p style="margin:4px 0 0; font-size:13px; color:#16a34a;">Funds will be transferred manually to your registered bank account.</p>
                        </td>
                    </tr>
                    @else
                    <!-- Rejected banner -->
                    <tr>
                        <td style="background-color:#fef2f2; border-bottom:1px solid #fecaca; padding:20px 32px;">
                            <p style="margin:0; font-size:16px; font-weight:700; color:#b91c1c;">❌ Withdrawal rejected</p>
                            <p style="margin:4px 0 0; font-size:13px; color:#dc2626;">See the admin notes below for details.</p>
                        </td>
                    </tr>
                    @endif
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fafafa; border:1px solid #e4e4e7; border-radius:8px; margin-bottom:24px;">
                                <tr>
                                    <td style="padding:16px 20px; border-bottom:1px solid #e4e4e7;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:1px; color:#a1a1aa;">Withdrawal Amount</p>
                                        <p style="margin:0; font-size:18px; font-weight:700;">Rp {{ number_format($withdrawal->amount, 0, ',', '.') }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:12px 20px;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:1px; color:#a1a1aa;">Destination Account</p>
                                ...
                                <tr>
                                    <td style="padding:12px 20px; border-top:1px solid #e4e4e7;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:1px; color:#a1a1aa;">Admin Notes</p>
                    ...
                    <tr>
                        <td style="padding:24px 32px; background-color:#fafafa; border-top:1px solid #e4e4e7;">
                            <p style="margin:0; font-size:12px; color:#a1a1aa; line-height:1.6;">
                                This email was sent because the status of a commission withdrawal request changed at SDP Marketplace.
                            </p>
                        </td>
                    </tr>
