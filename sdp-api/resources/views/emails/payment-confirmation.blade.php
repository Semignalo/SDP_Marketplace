                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="vertical-align:middle;">
                                        <p style="margin:0; font-size:16px; font-weight:700; color:#15803d;">Pembayaran berhasil dikonfirmasi!</p>
                                        <p style="margin:4px 0 0; font-size:13px; color:#16a34a;">Pesananmu sedang diproses oleh penjual.</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="margin:0 0 24px; font-size:14px; color:#52525b; line-height:1.6;">
                                Halo <strong>{{ $order->shipping_name }}</strong>, pembayaran untuk pesanan berikut sudah kami terima. Penjual akan segera mengemas dan mengirimkan pesananmu.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fafafa; border:1px solid #e4e4e7; border-radius:8px; margin-bottom:24px;">
                                ...
                                <tr>
                                    <td style="padding:12px 20px;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:1px; color:#a1a1aa;">Metode Pembayaran</p>
                                ...
                                <tr>
                                    <td style="padding:12px 20px; border-top:1px solid #e4e4e7;">
                                        <p style="margin:0 0 4px; font-size:11px; text-transform:uppercase; letter-spacing:1px; color:#a1a1aa;">Waktu Konfirmasi</p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:16px 0 24px;">
                                ...
                                <tr>
                                    <td style="padding:4px 0; font-size:13px; color:#16a34a;">Diskon Tier {{ $order->tier_name ?? '' }}</td>
                                ...
                                <tr>
                                    <td style="padding:12px 0 0; font-size:15px; font-weight:700; border-top:1px solid #e4e4e7;">Total Dibayar</td>
                    ...
                    <tr>
                        <td style="padding:24px 32px; background-color:#fafafa; border-top:1px solid #e4e4e7;">
                            <p style="margin:0; font-size:12px; color:#a1a1aa; line-height:1.6;">
                                Email ini dikirim karena ada pembayaran yang berhasil dikonfirmasi di SDP Marketplace.
                                Simpan link tracking di atas untuk memantau pengiriman pesananmu.
                            </p>
                        </td>
                    </tr>
